...
const info = document.getElementById("info"),
  ...
  [leftTime, rightTime] = document.querySelectorAll("#progress-time .time"),
  [playBtn, volumeBtn, progressTime] =
    document.querySelectorAll("#buttons-left .btn"),
  [previousBtn, rewindBtn, forwardBtn, nextBtn] = document.querySelectorAll(
    "#buttons-center .btn"
  ),
  [openFileBtn, settingsBtn, fullscreenBtn] = document.querySelectorAll(
    "#buttons-right .btn"
  );
...
class Utils {
  ...
  static formatTime(t) {
    ...
    if (m < 60) {
      ...
      h = Math.floor(m / 60);
      m %= 60;
      return `${h}:${10 > m ? "0" + m : m}:${10 > s ? "0" + s : s}`;
    }
  }
  static screenshot() {
...
class Controls {
  static init() {
    ...
    video.addEventListener("timeupdate", Controls.updateTracking);
    ...
    leftTime.addEventListener("click", Controls.changeTimeMode);
    ...
    Controls.hidden ||
      ...
      (Controls.progressDragging
        ...
        : ((progress.value = video.currentTime),
          (leftTime.textContent = remainingTimeMode
            ? "-" + Utils.formatTime(video.duration - video.currentTime)
  ...
  static onPause() {
    Controls.show();
    playBtn.src = "./src/images/play_arrow.svg";
  }
  static onPlay() {
  ...
  static onFullscreenChange() {
    getFullscreenElement()
      ? (fullscreenBtn.src = "./src/images/fullscreen_exit.svg")
      : (fullscreenBtn.src = "./src/images/fullscreen.svg");
  }
  ...
  static autoHide() {
    ...
    showTimer = setTimeout(Controls.hide, 2000);
  }
  static hide() {
